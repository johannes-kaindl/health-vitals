...
import { runReadmeGate } from "./lib/readme-gate.mjs";
...
// 1b. README-Drift-Gate (Sub-Spec B2, Layer 3): errors stoppen, Warnings nur Report.
//     Im Dry-Run nur Bericht (kein Abbruch); python3/Linter fehlt → Skip statt Hard-Fail.
runReadmeGate({ repoDir: ".", dryRun, die, log: console.log });
